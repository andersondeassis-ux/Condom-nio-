...
import { TrendingUp, TrendingDown, DollarSign, Activity, CheckCircle2, AlertCircle, Zap, Droplets, CalendarClock, AlertTriangle, PiggyBank, Wallet, ArrowRight, Users, Building2, MapPin, Shield } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ transactions, userEmail }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Capa do Condomínio com Imagem em Plano de Fundo */}
      <div className="relative rounded-2xl overflow-hidden shadow-lg border border-slate-200/80 min-h-[160px] sm:min-h-[180px] flex flex-col justify-end p-5 sm:p-6 text-white group">
        <img
          src="/condo_cover.jpg"
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-1.5 flex-wrap">
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-600/90 text-white backdrop-blur-sm shadow-sm">
            ...
            <p className="text-xs sm:text-sm text-slate-200 mt-0.5 max-w-xl">
              Painel de prestação de contas, convivência e controle operacional.
            </p>
          </div>

          <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md px-3.5 py-2 rounded-xl border border-white/20 text-xs text-white">
            <div className="flex -space-x-1.5 overflow-hidden">
              <div className="inline-block h-6 w-6 rounded-full ring-2 ring-white/50 bg-indigo-500 text-center font-bold leading-6 text-[10px]">101</div>
              <div className="inline-block h-6 w-6 rounded-full ring-2 ring-white/50 bg-emerald-500 text-center font-bold leading-6 text-[10px]">102</div>
              <div className="inline-block h-6 w-6 rounded-full ring-2 ring-white/50 bg-purple-500 text-center font-bold leading-6 text-[10px]">103</div>
            </div>
            <span className="font-medium text-slate-100">3 Unidades Ativas</span>
          </div>
        </div>
      </div>
